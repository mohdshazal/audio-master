        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection animation="fade-in-left" delay={200}>
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 text-white">
              Audio Excellence Since 2016
            </h2>

            <div className="space-y-4 text-white/70">
              <p>
                At Audio Master, we are passionate about delivering exceptional audio experiences. Founded in 2016, we have established ourselves as leaders in premium audio system installation and services.
              </p>
              <p>
